    ...
    <div className='flex justify-around font-DM_Sans flex-col relative gap-4'>
        ...
        <div className='flex justify-between '>
            <div className='text-left flex flex-col gap-4'>
                <p>{item.name}</p>
                {
                    clicked? ( <div className='flex text-xs gap-1'>
                        ...
                        <span >{item.rating}</span><span className='text-Gray'>{item.votes===0?"no ratings":`(${item.votes} votes)`}</span>
                    </div>) 
            ...
            <div className='flex flex-col justify-between align-bottom '>
                <p className='text-xs bg-light-green text-black px-2 rounded-md font-semibold  '>{item.price}</p>
                {item.available===false && <p className='text-xs text-light-red  rounded-md font-semibold  '>Sold out</p>}
            </div>
        </div>
    </div>
  )
