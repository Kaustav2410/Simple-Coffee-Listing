...
export const CollectionCard = () => { 
    ...
    return (
        <div className="bg-gray-900 max-w-[1100px] xl:max-w-[750px] lg:max-w-[450px] text-white flex-col gap-5 px-12 py-20 flex align-middle font-DM_Sans rounded-lg relative overflow-hidden mx-auto" >
                <h1 className=' text-xl '>Our Collection</h1>
                ...
                <p className='text-gray-400 max-w-[500px] mx-auto z-10'>Introducing our Coffee Collection, a selection of unique coffees from different roast types and origins, expertly roasted in small batches and shipped fresh weekly.</p>
