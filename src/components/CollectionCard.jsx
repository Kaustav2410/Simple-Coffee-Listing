...
export const CollectionCard = () => { 
    ...
    return (
        <div className="bg-light-black max-w-[1280px] mt-40 z-20 mx-[8.375rem] px-8 lg:px-20 xl:px-[7.75rem] pt-[6.3125rem] pb-[5.1875rem] rounded-xl overflow-hidden text-white mb-20 font-DM_Sans relative" >
